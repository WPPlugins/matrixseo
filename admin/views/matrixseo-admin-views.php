        ...
        if( isset($results) && count($results) && !isset($search_result) ): ?>
            ...
            <table class="widefat fixed" cellspacing="0">
                ...
                <?php foreach($results as $res): ?>
                    <tr>
                        <td alt="<?php echo str_replace($domain,"",$res['url_plain']); ?>"><?php echo str_replace($domain,"",$res['url_plain']); ?></td>
                        <td alt="<?php echo $res['action_id'] == 1 ? 'Enhance Title' : 'Change Content'; ?>"><?php echo $res['action_id'] == 1 ? 'Enhance Title' : 'Change Content'; ?></td>
