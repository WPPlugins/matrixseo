...
class MatrixSeo {
	...
	private function define_public_hooks() {
        ...
        $this->loader->add_filter( 'document_title_parts',		$this->reactor,'getHookPageTitleParts',     9999, 1);
        $this->loader->add_filter( 'pre_get_document_title',		$this->reactor,'getHookPageTitlePre',       9999, 1);
        $this->loader->add_filter( 'wp_title',                    $this->reactor,'getHookPageTitleTitle',     9999, 2);
        $this->loader->add_filter( 'document_title_parts',		$this->reactor,'handleChangeTitleParts',    9999, 1);
        $this->loader->add_filter( 'pre_get_document_title',		$this->reactor,'handleChangeTitlePre',      9999, 1);
        $this->loader->add_filter( 'wp_title',		            $this->reactor,'handleChangeTitleTitle',    9999, 2);
